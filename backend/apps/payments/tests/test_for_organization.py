...
from apps.payments.tests.factories import LoanFactory, PaymentFactory
from apps.users.tests.factories import UserFactory, WorkerProfileFactory
...
def test_loan_for_organization_isolates():
    ...
    loan_b = LoanFactory(worker=profile_b)
...
def test_payment_for_organization_isolates():
    ...
    pay_b = PaymentFactory(worker=profile_b)
